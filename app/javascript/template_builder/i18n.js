const en = {
  ...
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more:
    "Obtain qualified electronic signature (QeS) with the trusted provider. Click to learn more.",
  editable: "Editable",
  recurrent: "Recurrent",
  one_off: "One-off",
  ...
  uploaded_pdf_contains_form_fields_keep_or_remove_them:
  ...
  no_variables_description:
    "Add [[variable]] marks to your document to create dynamic content variables.",
  ...
  please_draw_fields_to_prepare_the_document:
    "Please draw fields to prepare the document.",
  ...
  please_add_fields_for_the_submitter_name_or_remove_the_submitter_name_if_not_needed:
    "Please add fields for the {submitter_name}. Or, remove the {submitter_name} if not needed.",
  ...
  some_fields_are_missing_in_the_formula:
    "Some fields are missing in the formula.",
  learn_more: "Learn more",
  and: "and",
  or: "or",
  start_a_quick_tour_to_learn_how_to_create_and_send_your_first_document:
    "Start a quick tour to learn how to create and send your first document",
...
const es = {
  ...
  draw_strikethrough_the_document:
    "Dibujar una línea de tachado en el documento",
  quantity: "Cantidad",
  ...
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more:
    "Obtenga una firma electrónica cualificada (QeS) con el proveedor de confianza. Haga clic para obtener más información.",
  ...
  no_variables_description:
    "Agregue marcas [[variable]] a su documento para crear variables de contenido dinámico.",
  ...
  add_all_required_fields_to_continue:
    "Agregar todos los campos requeridos para continuar",
  uploaded_pdf_contains_form_fields_keep_or_remove_them:
    "El PDF cargado tiene campos. ¿Mantenerlos o eliminarlos?",
  keep: "Mantener",
  left: "Izquierda",
  heading: "Encabezado",
  ...
  draw_a_text_field_on_the_page_with_a_mouse:
    "Dibujar un campo de texto en la página con el mouse",
  drag_and_drop_any_other_field_type_on_the_page:
    "Arrastra y suelta cualquier otro tipo de campo en la página",
  click_on_the_field_type_above_to_start_drawing_it:
    "Haz clic en el tipo de campo de arriba para comenzar a dibujarlo",
  please_draw_fields_to_prepare_the_document:
    "Por favor, dibuja los campos para preparar el documento.",
  ...
  please_add_fields_for_the_submitter_name_or_remove_the_submitter_name_if_not_needed:
    "Por favor, añade campos para {submitter_name} o elimina {submitter_name} si no es necesario.",
  ...
  some_fields_are_missing_in_the_formula:
    "Faltan algunos campos en la fórmula.",
  learn_more: "Aprende más",
  and: "y",
  or: "o",
  start_a_quick_tour_to_learn_how_to_create_and_send_your_first_document:
    "Inicia una guía rápida para aprender a crear y enviar tu primer documento.",
...
const it = {
  ...
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more:
    "Ottieni una firma elettronica qualificata (QeS) con il fornitore di fiducia. Clicca per saperne di più.",
  ...
  height: "Altezza",
  add_all_required_fields_to_continue:
    "Aggiungi tutti i campi obbligatori per continuare",
  uploaded_pdf_contains_form_fields_keep_or_remove_them:
    "Il PDF caricato contiene campi del modulo. Mantenerli o rimuoverli?",
  keep: "Mantieni",
  left: "Sinistra",
  ...
  no_variables_description:
    "Aggiungi marcatori [[variable]] al documento per creare variabili di contenuto dinamico.",
  ...
  location_field: "Campo posizione",
  draw_a_text_field_on_the_page_with_a_mouse:
    "Disegna un campo di testo sulla pagina con il mouse",
  drag_and_drop_any_other_field_type_on_the_page:
    "Trascina e rilascia qualsiasi altro tipo di campo sulla pagina",
  click_on_the_field_type_above_to_start_drawing_it:
    "Clicca sul tipo di campo sopra per iniziare a disegnarlo",
  please_draw_fields_to_prepare_the_document:
    "Per favore, disegna i campi per preparare il documento.",
  ...
  please_add_fields_for_the_submitter_name_or_remove_the_submitter_name_if_not_needed:
    "Aggiungi campi per {submitter_name} o rimuovi {submitter_name} se non necessario.",
  ...
  or: "o",
  start_a_quick_tour_to_learn_how_to_create_and_send_your_first_document:
    "Inizia un tour rapido per imparare a creare e inviare il tuo primo documento.",
...
const pt = {
  ...
  verify_id: "Verificar ID",
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more:
    "Obtenha a assinatura eletrônica qualificada (QeS) com o provedor confiável. Clique para saber mais.",
  ...
  no_variables_description:
    "Adicione marcações [[variable]] ao documento para criar variáveis de conteúdo dinâmico.",
  type_value: "Digite valor",
  add_all_required_fields_to_continue:
    "Adicione todos os campos obrigatórios para continuar",
  uploaded_pdf_contains_form_fields_keep_or_remove_them:
    "O PDF carregado contém campos. Manter ou removê-los?",
  keep: "Manter",
  align: "Alinhar",
  resize: "Redimensionar",
  width: "Largura",
  ...
  draw_a_text_field_on_the_page_with_a_mouse:
    "Desenhar um campo de texto na página com o mouse",
  drag_and_drop_any_other_field_type_on_the_page:
    "Arraste e solte qualquer outro tipo de campo na página",
  click_on_the_field_type_above_to_start_drawing_it:
    "Clique no tipo de campo acima para começar a desenhá-lo",
  please_draw_fields_to_prepare_the_document:
    "Por favor, desenhe os campos para preparar o documento.",
  only_pdf_and_images_are_supported: "Apenas PDFs e imagens são suportados.",
  unlock_sms_verified_phone_number_field_with_paid_plan_use_text_field_for_phone_numbers_without_verification:
    "Desbloqueie o campo de número de telefone verificado por SMS com um plano pago. Use o campo de texto para números de telefone sem verificação.",
  available_only_in_pro: "Disponível apenas no Pro",
  failed_to_download_files: "Falha ao baixar arquivos",
  please_add_fields_for_the_submitter_name_or_remove_the_submitter_name_if_not_needed:
    "Adicione campos para {submitter_name} ou remova {submitter_name} se não for necessário.",
  ...
  or: "ou",
  start_a_quick_tour_to_learn_how_to_create_and_send_your_first_document:
    "Comece um tour rápido para aprender a criar e enviar seu primeiro documento.",
...
const fr = {
  ...
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more:
    "Obtenez une signature électronique qualifiée (QeS) auprès du fournisseur de confiance. Cliquez pour en savoir plus.",
  editable: "Modifiable",
  recurrent: "Récurrent",
  one_off: "Ponctuel",
  ...
  height: "Hauteur",
  add_all_required_fields_to_continue:
    "Ajoutez tous les champs obligatoires pour continuer",
  uploaded_pdf_contains_form_fields_keep_or_remove_them:
    "Le PDF téléversé contient des champs de formulaire. Les conserver ou les supprimer ?",
  keep: "Conserver",
  left: "Gauche",
  heading: "Titre",
  validation: "Validation",
  ...
  no_variables_description:
    "Ajoutez des balises [[variable]] à votre document pour créer des variables de contenu dynamique.",
  ...
  draw_a_text_field_on_the_page_with_a_mouse:
    "Dessinez un champ de texte sur la page avec la souris",
  drag_and_drop_any_other_field_type_on_the_page:
    "Glissez-déposez tout autre type de champ sur la page",
  click_on_the_field_type_above_to_start_drawing_it:
    "Cliquez sur le type de champ ci-dessus pour commencer à le dessiner",
  please_draw_fields_to_prepare_the_document:
    "Veuillez dessiner des champs pour préparer le document.",
  only_pdf_and_images_are_supported:
    "Seuls les PDF et les images sont pris en charge.",
  unlock_sms_verified_phone_number_field_with_paid_plan_use_text_field_for_phone_numbers_without_verification:
    "Débloquez le champ de numéro de téléphone vérifié par SMS avec un forfait payant. Utilisez un champ texte pour les numéros sans vérification.",
  ...
  please_add_fields_for_the_submitter_name_or_remove_the_submitter_name_if_not_needed:
    "Veuillez ajouter des champs pour {submitter_name}. Ou supprimez {submitter_name} si ce n'est pas nécessaire.",
  ...
  some_fields_are_missing_in_the_formula:
    "Certains champs manquent dans la formule.",
  learn_more: "En savoir plus",
  and: "et",
  or: "ou",
  start_a_quick_tour_to_learn_how_to_create_and_send_your_first_document:
    "Commencez une visite rapide pour apprendre à créer et à envoyer votre premier document",
  start_tour: "Démarrer",
...
const de = {
  ...
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more:
    "Qualifizierte elektronische Signatur (QES) beim vertrauenswürdigen Anbieter einholen. Klicken Sie, um mehr zu erfahren.",
  ...
  height: "Höhe",
  add_all_required_fields_to_continue:
    "Fügen Sie alle erforderlichen Felder hinzu, um fortzufahren",
  uploaded_pdf_contains_form_fields_keep_or_remove_them:
    "Das hochgeladene PDF enthält Formularfelder. Beibehalten oder entfernen?",
  keep: "Beibehalten",
  left: "Links",
  heading: "Überschrift",
  ...
  no_variables_description:
    "Fügen Sie [[variable]]-Markierungen zu Ihrem Dokument hinzu, um dynamische Inhaltsvariablen zu erstellen.",
  ...
  draw_a_text_field_on_the_page_with_a_mouse:
    "Ein Textfeld mit der Maus auf der Seite zeichnen",
  drag_and_drop_any_other_field_type_on_the_page:
    "Jeden anderen Feldtyp auf die Seite ziehen und ablegen",
  click_on_the_field_type_above_to_start_drawing_it:
    "Klicken Sie oben auf den Feldtyp, um mit dem Zeichnen zu beginnen",
  please_draw_fields_to_prepare_the_document:
    "Bitte zeichnen Sie Felder, um das Dokument vorzubereiten.",
  only_pdf_and_images_are_supported: "Nur PDF und Bilder werden unterstützt.",
  unlock_sms_verified_phone_number_field_with_paid_plan_use_text_field_for_phone_numbers_without_verification:
    "SMS-verifiziertes Telefonnummernfeld mit kostenpflichtigem Plan freischalten. Verwenden Sie für Telefonnummern ohne Verifizierung das Textfeld.",
  available_only_in_pro: "Nur in Pro verfügbar",
  failed_to_download_files: "Dateien konnten nicht heruntergeladen werden",
  please_add_fields_for_the_submitter_name_or_remove_the_submitter_name_if_not_needed:
    "Bitte fügen Sie Felder für {submitter_name} hinzu oder entfernen Sie {submitter_name}, falls nicht benötigt.",
  ...
  or: "oder",
  start_a_quick_tour_to_learn_how_to_create_and_send_your_first_document:
    "Starten Sie eine Kurztour, um zu lernen, wie Sie Ihr erstes Dokument erstellen und versenden.",
...
const nl = {
  ...
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more:
    "Verkrijg een gekwalificeerde elektronische handtekening (QeS) via de vertrouwde provider. Klik voor meer informatie.",
  editable: "Bewerkbaar",
  ...
  height: "Hoogte",
  add_all_required_fields_to_continue:
    "Voeg alle vereiste velden toe om door te gaan",
  uploaded_pdf_contains_form_fields_keep_or_remove_them:
    "Geüploade PDF bevat formuliervelden. Behouden of verwijderen?",
  keep: "Behouden",
  left: "Links",
  heading: "Koptekst",
  ...
  no_variables_description:
    "Voeg [[variable]]-markeringen toe aan uw document om dynamische inhoudsvariabelen te maken.",
  ...
  location_field: "Locatieveld",
  draw_a_text_field_on_the_page_with_a_mouse:
    "Teken met de muis een tekstveld op de pagina",
  drag_and_drop_any_other_field_type_on_the_page:
    "Sleep elk ander veldtype naar de pagina",
  click_on_the_field_type_above_to_start_drawing_it:
    "Klik op het bovenstaande veldtype om te beginnen met tekenen",
  please_draw_fields_to_prepare_the_document:
    "Teken velden om het document voor te bereiden.",
  only_pdf_and_images_are_supported:
    "Alleen PDF en afbeeldingen worden ondersteund.",
  unlock_sms_verified_phone_number_field_with_paid_plan_use_text_field_for_phone_numbers_without_verification:
    "Ontgrendel het SMS-geverifieerde veld voor telefoonnummer met een betaald abonnement. Gebruik het tekstveld voor telefoonnummers zonder verificatie.",
  available_only_in_pro: "Alleen beschikbaar in Pro",
  failed_to_download_files: "Bestanden downloaden mislukt",
  please_add_fields_for_the_submitter_name_or_remove_the_submitter_name_if_not_needed:
    "Voeg velden toe voor de {submitter_name}. Of verwijder de {submitter_name} als deze niet nodig is.",
  ...
  some_fields_are_missing_in_the_formula:
    "Sommige velden ontbreken in de formule.",
